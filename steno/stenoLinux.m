...
myOwnDictionary= {
    "ultimately"->"ULT/PHAT/HREU",(*ult-mat-ly*)
    "intuitively"->"EUPB/TAOUT/EUFL",
    "defining"->"TKE/TPAOEUPBG",
    "special"->"SPERBL",
    "define"->"TKE/TPAOEUPB",
    "theories"->"THAOER/EUS",
    "individual"->"EUPB/TKEU/SREUD/KWRAOUL",
    "steno"->"STEPB/TPHOE",
  "several"->"SEFRL",
  "suppress"->"SPRES",
  "averages"->"AFRGS",
...
$ii =Module[{}, Join[
   ...
   Import[$HomeDirectory<>"/Dropbox/05_PROGRAMS/17_steno/000_plover_dictionary/02_truncated_dictionary_linux_.json"]

   ]];
di[str_String] := dictionary[StringJoin[StringSplit[str]]];


dictionary[str_String] := Module[{j},
